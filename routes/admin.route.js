...
module.exports = (app) => {
    ...
    router.post("admin/case/add", [authJwt.verifyToken], auth.createCase);
    router.get("admin/case/all", auth.getCase);
    router.get("admin/case/get/:id", auth.getIdCase);
    router.delete("admin/case/delete/:id", auth.deleteCase);
    app.put("admin/case/update", [authJwt.verifyToken], auth.updateCase);
    router.post("admin/court/add", [authJwt.verifyToken], auth.createCourt);
    router.get("admin/court/all", auth.getCourt);
    router.get("admin/court/get/:id", auth.getCourtId);
    router.delete("admin/court/delete/:id", auth.deleteCourt);
